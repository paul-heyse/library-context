...
- ADR-0020, ADR-0024, ADR-0025 and ADR-0028 remain proposed. ADR-0039 supersedes ADR-0038; ADR-0037 supersedes ADR-0036. Separate uncommitted design-review process edits appeared in this shared tree during the checkpoint: draft ADR-0040, ADR-0023, core principles/template, the review skill and reviewer-agent instructions. Preserve and reconcile them independently from this Stage 3 work. The last ADR index/lint predate that draft.
