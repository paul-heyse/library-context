...
| [`rust-reasoning/`](rust-reasoning/SKILL.md) | symbolic reasoning over conditions and relations: biodivine-lib-bdd 0.6.3, OxiDD 0.12.0, z3 0.21.1 / z3-sys 0.13.1 (system libz3), ascent 0.8.1, datafrog 2.0.1, fcars 0.2.2; a library ladder, 16 briefs, executed interop routes | docs.rs plus local all-features captures of 12 crates, and 24 behaviour and 9 compile/link **executed** probes |
