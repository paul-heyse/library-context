...
pub fn files(dimensions: i32) -> Vec<ServingFile> {
    ...
    vec![
        ...
        file(
            ...
            vec![
                id("finding_id", false),
                utf8("finding_kind", false),
                utf8("evidence_status", false),
                id("subject_node_id", false),
                id("related_node_id", true),
                id("invocation_id", false),
                utf8("model_id", false),
                utf8("method", false),
                utf8("parameters", false),
                utf8("completion", false),
                utf8("stop_reason", true),
                Field::new("witnesses_omitted", DataType::Boolean, false),
            ],
            &["finding_id"],
        ),
        file(
            ...
            vec![
                ...
                id("callee_node_id", false),
                utf8("arc_kind", false),
                utf8("modality", false),
                utf8("phase", true),
                id("source_fact_id", true),
                utf8("source_path", true),
                int("start_byte", true),
                int("end_byte", true),
            ],
            &["finding_id", "path", "step"],
        ),
        file(
            "support_members",
            vec![
                ...
                int("ordinal", false),
                id("node_id", true),
                id("cited_fact_id", true),
                utf8("fact_table", true),
                utf8("fact_model_id", true),
                utf8("label", true),
            ],
            &["finding_id", "role", "ordinal"],
        ),
        file(
            "evidence",
            vec![
        ...
        file(
            ...
            vec![
                ...
                utf8("output_path", false),
                utf8("kind", false),
                id("condition_id", false),
                utf8("verdict", false),
                utf8("boundary_reason", true),
                id("source_flow_fact_id", false),
                id("source_origin_id", false),
                id("return_site_fact_id", false),
                id("return_region_fact_id", false),
                Field::new("approximated", DataType::Boolean, false),
                int("path_depth", false),
            ],
            &["summary_id"],
        ),
        file(
        ...
        file(
            ...
            vec![
                ...
                id("formal_node_id", false),
                id("module_node_id", false),
                id("leaf_fact_id", false),
                id("atom_id", false),
                id("condition_id", false),
                utf8("place", false),
                utf8("origin", false),
                digest("effect_model_digest", false),
                id("use_id", false),
                id("use_fact_id", false),
                id("reaching_fact_id", false),
                id("definition_fact_id", false),
                id("stability_origin_id", true),
                id("stability_condition_id", true),
                utf8("path", true),
                int("operand_start_byte", false),
