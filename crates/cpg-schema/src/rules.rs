...
pub const REFERENCES: &[Reference] = &[
    ...
    r("modeled_exact_value_transfers", "flow_value_fact_id", &[("flow_values", "fact_id")]),
    r("modeled_exact_value_transfers", "flow_value_call_fact_id", &[("flow_value_calls", "fact_id")]),
    r("modeled_exact_value_transfers", "call_site_node_id", &[("call_syntax", "node_id")]),
    r("modeled_exact_value_transfers", "call_fact_id", FACT),
    r("modeled_exact_value_transfers", "argument_node_id", &[("arguments", "node_id")]),
    r("modeled_exact_value_transfers", "argument_fact_id", FACT),
    r("modeled_exact_value_transfers", "function_node_id", &[("declarations", "node_id")]),
    r("modeled_exact_value_transfers", "parameter_node_id", &[("parameter_syntax", "node_id")]),
    r("modeled_exact_value_transfers", "use_id", &[("flow_uses", "use_id")]),
    r("modeled_exact_value_transfers", "condition_id", &[("analysis_conditions", "condition_id")]),
    r("modeled_exact_value_transfers", "pysa_fact_id", FACT),
    r("modeled_exact_value_transfers", "target_node_id", &[("model_targets", "target_node_id")]),
    ...
    r("value_flow_predecessor_candidates", "function_node_id", &[("declarations", "node_id")]),
    r("value_flow_predecessor_candidates", "successor_use_id", &[("flow_uses", "use_id")]),
    r("value_flow_predecessor_candidates", "predecessor_use_id", &[("flow_uses", "use_id")]),
    r("value_flow_predecessor_candidates", "reaching_fact_id", FACT),
    ...
    r("modeled_assignment_return_paths", "successor_fact_id", &[("flow_values", "fact_id")]),
    r("modeled_assignment_return_paths", "predecessor_fact_id", &[("flow_values", "fact_id")]),
    r("modeled_assignment_return_paths", "reaching_fact_id", FACT),
    r("modeled_assignment_return_paths", "function_node_id", &[("declarations", "node_id")]),
    r("modeled_assignment_return_paths", "parameter_node_id", &[("parameter_syntax", "node_id")]),
    r("modeled_assignment_return_paths", "call_site_node_id", &[("call_syntax", "node_id")]),
    r("modeled_assignment_return_paths", "call_fact_id", FACT),
    r("modeled_assignment_return_paths", "pysa_fact_id", FACT),
    r("modeled_assignment_return_paths", "model_id", &[("model_targets", "model_id")]),
    r("modeled_assignment_return_paths", "rule_id", &[("model_transfers", "rule_id")]),
    r("modeled_assignment_return_paths", "target_definition_fact_id", FACT),
    ...
    r("summary_components", "function_node_id", &[("declarations", "node_id")]),
    ...
    r("summary_flow_steps", "evidence_id", &[("flow_values", "fact_id"), ("reference_resolutions", "fact_id"), ("syntax_nodes", "fact_id"), ("call_syntax", "fact_id"), ("call_targets", "pysa_fact_id"), ("model_transfers", "rule_id"), ("flow_reaching", "fact_id"), ("summary_flows", "summary_id")]),
    ...
    r("modeled_exception_return_none_paths", "source_syntax_fact_id", FACT),
    r(
        "modeled_exception_return_none_paths",
        "raised_class_node_id",
        &[("context_definitions", "symbol_node_id")],
    ),
    r("modeled_exception_return_none_paths", "raised_class_fact_id", FACT),
    r(
        "modeled_exception_return_none_paths",
        "try_node_id",
        &[("syntax_nodes", "node_id")],
    ...
    r("modeled_exception_return_none_paths", "handler_fact_id", FACT),
    r("modeled_exception_return_none_paths", "class_mro_fact_id", FACT),
    r(
        "modeled_exception_return_none_paths",
        "return_node_id",
        &[("syntax_nodes", "node_id")],
    ),
    r("modeled_exception_return_none_paths", "return_fact_id", FACT),
    r(
        "modeled_exception_return_none_paths",
        "none_node_id",
        &[("syntax_nodes", "node_id")],
    ...
    r("modeled_exception_return_none_paths", "handler_region_fact_id", FACT),
    r(
        "modeled_exception_return_none_paths",
