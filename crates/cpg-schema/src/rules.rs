...
pub const REFERENCES: &[Reference] = &[
    ...
    r("modeled_direct_return_transfers", "flow_value_fact_id", &[("flow_values", "fact_id")]),
    r("modeled_direct_return_transfers", "flow_value_call_fact_id", &[("flow_value_calls", "fact_id")]),
    r("modeled_direct_return_transfers", "call_site_node_id", &[("call_syntax", "node_id")]),
    r("modeled_direct_return_transfers", "call_fact_id", FACT),
    r("modeled_direct_return_transfers", "argument_node_id", &[("arguments", "node_id")]),
    r("modeled_direct_return_transfers", "argument_fact_id", FACT),
    ...
    r("modeled_direct_return_transfers", "rule_id", &[("model_transfers", "rule_id")]),
    r("modeled_direct_return_transfers", "target_definition_fact_id", FACT),
